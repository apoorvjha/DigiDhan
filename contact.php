...
xhr.onload=function(){
const serverResponse=document.getElementById("super_chats");
serverResponse.innerHTML=this.responseText;
};
xhr.open("POST","super_chat_fetch.php");
xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xhr.send();
}
function sync_chats()
{fetch_chats();
window.setInterval(fetch_chats,2000);
}
</script>
...
{
echo'<li><a class="active" href="">Contact</a></li>';
}
...
<br>
<center>
<div class="super_chats" id="super_chats">
